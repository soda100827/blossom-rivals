...
function v_u_4.PlayClient(p9, ...)
    for _, v10 in pairs(p9:_GetObjects(true)) do
        if v10:IsA("BasePart") then
            v10.Color = Color3.fromRGB(205, 208, 255)
    ...
    p9:CreateSound("rbxassetid://94496162153937", 2, 1 + 0.2 * math.random(), nil, true, 5)
    p9:CreateSound("rbxassetid://126265374362193", 2, 1 + 0.2 * math.random(), nil, true, 5)
    p9:CreateSound("rbxassetid://104909327141208", 1, 1 + 0.2 * math.random(), nil, true, 5)
