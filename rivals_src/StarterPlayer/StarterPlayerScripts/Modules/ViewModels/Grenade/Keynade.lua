...
local v_u_6 = v2.LocalPlayer.PlayerScripts.Assets.Misc:WaitForChild("KeynadeExplosionEffect"):WaitForChild("Attachment")
...
function v_u_7.ExplosionEffect(_, p11, p12)
    ...
    v_u_4:CreateSound("rbxassetid://18179281854", 2, 0.9 + 0.2 * math.random(), v13, true, 10)
