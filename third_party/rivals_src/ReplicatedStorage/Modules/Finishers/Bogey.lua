...
function v_u_4.PlayServer(p8)
    if p8._is_humanoid then
        ...
        v_u_2:AddItem(v10, 1.25)
        local v12 = Instance.new("Animation")
        v12.AnimationId = "rbxassetid://134297251758422"
...
function v_u_4.PlayClient(p15)
    if p15._is_humanoid then
        ...
        v16.AnimationId = "rbxassetid://134297251758422"
        ...
        wait(0.45)
        p15:CreateSound("rbxassetid://7127702569", 1, 1.2, nil, true, 5)
        wait(0.35)
        p15:CreateSound("rbxassetid://5269180135", 1.25, 1 + 0.2 * math.random(), nil, true, 5)
        wait(0.4)
        p15:CreateSound("rbxassetid://138311549816447", 1.25, 1 + 0.2 * math.random(), nil, true, 5)
        wait(0.8)
        p15:CreateSound("rbxassetid://7127702569", 1, 0.8, nil, true, 5)
    end
end
