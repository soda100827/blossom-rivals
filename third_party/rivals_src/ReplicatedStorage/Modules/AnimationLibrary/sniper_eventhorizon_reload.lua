return function(p1, p2, p3)
    p1:CreateSound("rbxassetid://113227486192611", 0.875, 1 + 0.1 * math.random(), true, 10)
    p1:CreateSound("rbxassetid://122971606160018", 0.875, 1 + 0.1 * math.random(), true, 10)
    if p1:_AnimationWait(script.Name, p2, 0.68 / p3) then
        ...
        if p1:_AnimationWait(script.Name, p2, 0.75 / p3) then
            ...
            if p1:_AnimationWait(script.Name, p2, 0.47 / p3) then
