...
function v_u_12.SetBanData(p_u_16, p17, p18)
	...
	if p_u_16._ban_data then
		...
		local v31 = p_u_16._player_data
			and (p_u_16._player_data.Seasons and p_u_16._player_data.Seasons[v_u_5.CurrentSeason.Name])
		if v31 then
		...
		p_u_16.StatusText.Text = v24
				and ("Banned [" .. (v25 == 999999999 and "Permanent" or v_u_6:TimeFormat2(
					p_u_16._ban_data.TimeRemaining
				)) .. "]" or "Unbanned")
			or "Unbanned"
		p_u_16.StatusText.TextColor3 = v24 and Color3.fromRGB(255, 50, 50) or Color3.fromRGB(100, 255, 50)
		p_u_16.BanHistoryText.Text = v24 and "Current ban reason: " .. p_u_16._ban_data.BanHistory[1].Reason
			or (
				#p_u_16._ban_data.BanHistory > 0 and "This player has a ban history" or "This player has no ban history"
			)
		p_u_16.BanHistoryText.TextColor3 = #p_u_16._ban_data.BanHistory > 0 and Color3.fromRGB(255, 50, 50)
			or Color3.fromRGB(157, 157, 157)
...
function v_u_12._FetchPlayerData(p52)
	if p52._player_data_debounce then
		...
		local v53, v54 = pcall(
			v_u_1.Remotes.Moderator.RequestPlayerData.InvokeServer,
			v_u_1.Remotes.Moderator.RequestPlayerData,
			p52._ban_data.Name
		)
	...
	if p55._lookup_disabled then
		...
		if #v56 ~= 0 then
			...
			local v57 = {
				{
					Name = v56,
					UserID = game.Players:GetUserIdFromNameAsync(v56) or 1,
					TimeRemaining = 0,
					BanHistory = {},
					RedFlags = nil,
				},
